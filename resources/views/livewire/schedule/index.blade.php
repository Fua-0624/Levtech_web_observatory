                        ...
                        @foreach($observatories as $observatory)
                            <div class="dropdown-item">
                                <div class="icheck-info">
                                    <input type="checkbox" id="filter_user_{{ $observatory->id }}"
                                           name="selectStoreIds" value="{{ $observatory->id }}"
                                           wire:model.lazy="selectedUserIds"/>
                                    <label class="font-weight-normal" for="filter_user_{{ $observatory->id }}">
                                        {{ $observatory->name }}
                                    </label>
                                </div>
                            </div>
